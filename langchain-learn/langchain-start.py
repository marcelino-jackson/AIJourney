...
def main():
    ...
    summary_prompt_template = PromptTemplate(
        input_variables=["information"], template=prompt_with_text2parse
    )

    # OpenAI example (uncomment to use OpenAI instead of Ollama)
    llm = ChatOpenAI(
    ...
    # OLLAMA example (uncomment to use Ollama instead of OpenAI)
    # llm = ChatOllama(
    #     model="gpt-oss:20b",
    #     temperature=0,
    #     verbose=True,
    ...
    response = chain.invoke(input={"information": text2parse})
